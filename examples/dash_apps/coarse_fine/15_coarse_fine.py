...
app.clientside_callback(
    ClientsideFunction(namespace="clientside2", function_name="set_coarse_range"),
...
# update range with clientside callback
app.clientside_callback(
    ClientsideFunction(namespace="clientside2", function_name="update_main_with_coarse"),
    Output("plotly-resampler-graph", "id", allow_duplicate=True),
...
app.clientside_callback(
    ClientsideFunction(namespace="clientside2", function_name="update_coarse_selectbox"),
