...
fig.replace(make_subplots(rows=3, cols=2))
fig.toggle_overview({'visible': True, 
                    "linked_subplots": [0,1]})
fig.add_trace(go.Scattergl(name="log", line=dict(color="#F9CDD5")), hf_x=x, hf_y=noisy_sin * 0.9999995**x, row=1, col=1)
fig.add_trace(go.Scattergl(name="exp"), hf_x=x, hf_y=noisy_sin * 1.000002**x, row=1, col=1)

fig.add_trace(go.Scattergl(name="log"), hf_x=x, hf_y=noisy_sin * 0.9999995**x, row=1, col=2)
fig.add_trace(go.Scattergl(name="exp"), hf_x=x, hf_y=noisy_sin * 1.000002**x, row=1, col=2)

fig.add_trace(go.Scattergl(name="log"), hf_x=x, hf_y=noisy_sin * 0.9999995**x, row=2, col=1)
fig.add_trace(go.Scattergl(name="exp"), hf_x=x, hf_y=noisy_sin * 1.000002**x, row=2, col=1)

fig.add_trace(go.Scattergl(name="log"), hf_x=x, hf_y=noisy_sin * 0.9999995**x, row=2, col=2)
fig.add_trace(go.Scattergl(name="exp"), hf_x=x, hf_y=noisy_sin * 1.000002**x, row=2, col=2)

fig.add_trace(go.Scattergl(name="log"), hf_x=x, hf_y=noisy_sin * 0.9999995**x, row=3, col=1)
fig.add_trace(go.Scattergl(name="exp"), hf_x=x, hf_y=noisy_sin * 1.000002**x, row=3, col=2)
