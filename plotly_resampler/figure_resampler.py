...
class AbstractFigureAggregator(BaseFigure, ABC):
    def __init__(
        ...
        if convert_existing_traces:
            ...
            f_ = figure.__class__(layout=figure.layout)
...
class FigureWidgetAggregator(go.FigureWidget):
    def __init__(
        self,
        ...
        if convert_existing_traces:
            # call __init__ with the correct layout and set the `_grid_ref` of the
            # to-be-converted figure
            f_ = go.FigureWidget(layout=figure.layout)
            f_._grid_ref = figure._grid_ref
            super().__init__(f_)
...
class FigureResampler(AbstractFigureAggregator):
    def __init__(
        self,
